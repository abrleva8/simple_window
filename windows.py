...
def about_information():
    ...
    msg.setWindowIcon(QtGui.QIcon(script_dir + os.path.sep + 'logo.png'))
...
def handle_timeout():
    for w in QtWidgets.QApplication.topLevelWidgets():
        if isinstance(w, QtWidgets.QFileDialog):
            w.setWindowIcon(QtGui.QIcon("logo.png"))
...
class UiMainWindow(object):
    ...
    data_liragrutid = []
    data = []
    person_ = person.Person([""] * count_of_var)
    drugs = None
    ...
    def setup_ui(self, main_window_):
        ...
        # script_dir = os.path.dirname(os.path.realpath(__file__))
        main_window_.setWindowIcon(QtGui.QIcon(self.script_dir + os.path.sep + 'logo.png'))
        ...
        self.centralwidget.setWindowIcon(QtGui.QIcon(self.script_dir + os.path.sep + 'logo.png'))

        self.l_snils.setGeometry(QtCore.QRect(0, 10, 151, 31))
        ...
        self.l_pet.setGeometry(QtCore.QRect(550, 130, 141, 31))
        ...
        self.cb_pet.setGeometry(QtCore.QRect(720, 130, 104, 31))
        ...
        self.l_mzo.setGeometry(QtCore.QRect(550, 170, 141, 31))
        ...
        self.cb_mzo.setGeometry(QtCore.QRect(720, 170, 104, 31))
        ...
        self.l_ohs.setGeometry(QtCore.QRect(270, 130, 141, 31))
        ...
        self.te_ohs.setGeometry(QtCore.QRect(440, 130, 104, 31))
        ...
        self.l_lpvp.setGeometry(QtCore.QRect(270, 50, 141, 31))
        ...
        self.te_lpvp.setGeometry(QtCore.QRect(440, 50, 104, 31))
        ...
        self.l_lpnp.setGeometry(QtCore.QRect(270, 90, 141, 31))
        ...
        self.te_lpnp.setGeometry(QtCore.QRect(440, 90, 104, 31))
        ...
        self.l_tg.setGeometry(QtCore.QRect(550, 10, 141, 31))
        ...
        self.te_tg.setGeometry(QtCore.QRect(720, 10, 104, 31))
        ...
        self.l_height.setGeometry(QtCore.QRect(0, 90, 151, 31))
        ...
        self.te_height.setGeometry(QtCore.QRect(150, 90, 104, 31))
        ...
        self.l_hips_girph.setGeometry(QtCore.QRect(0, 130, 151, 31))
        ...
        self.te_hips_girph.setGeometry(QtCore.QRect(150, 130, 104, 31))
        ...
        self.l_glucose.setGeometry(QtCore.QRect(270, 170, 141, 31))
        ...
        self.te_glucose.setGeometry(QtCore.QRect(440, 170, 104, 31))
        ...
        self.cb_sex.setGeometry(QtCore.QRect(150, 50, 104, 31))
        ...
        self.l_sex.setGeometry(QtCore.QRect(0, 50, 151, 31))
        ...
        self.l_weight.setGeometry(QtCore.QRect(270, 10, 141, 31))
        ...
        self.te_weight.setGeometry(QtCore.QRect(440, 10, 104, 31))
        ...
        self.l_waist.setGeometry(QtCore.QRect(0, 170, 151, 31))
        ...
        self.te_waist.setGeometry(QtCore.QRect(150, 170, 104, 31))
        ...
        self.l_pulse.setGeometry(QtCore.QRect(550, 90, 141, 31))
        ...
        self.te_pulse.setGeometry(QtCore.QRect(720, 90, 104, 31))
        ...
        self.l_insulin.setGeometry(QtCore.QRect(550, 50, 141, 31))
        ...
        self.te_insulin.setGeometry(QtCore.QRect(720, 50, 104, 31))
    ...
    def some_work(self):
        ...
        self.person_ = person.Person(self.data)
        flag = self.person_.is_good_data()
    ...
    def get_data_from_label(self):
        ...
        # self.some_work()
        if not self.person_.is_good_data():
        ...
        self.data_diet.append(self.person_.index_noma)
        ...
        self.te_result.setPlainText(f"{verb} {res_drug} пациент похудеет на {res_number}% (примерно на "
                                    f"{self.person_.resulting_weight(res_number)} кг) в течение 3 месяцев")

    def file_save(self):
        QtCore.QTimer.singleShot(0, handle_timeout)
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        file_name, _ = QFileDialog.getSaveFileName(None, "Сохранение схемы лечения", "", "Text files (*.txt)",
                                                   options=options)
        try:
            ...
            return
        if os.path.isfile(file_name) and self.person_.is_good_data():
            file = open(file_name, 'w')
            text = self.person_.data_to_save()
